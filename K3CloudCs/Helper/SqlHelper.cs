...
namespace K3CloudCs
{
    public class SqlHelper
    {
        ...
        /// </summary> 
        /// <returns></returns> 
        public static string GetConnSting(string connectionName)
        {
            string file = System.Reflection.Assembly.GetExecutingAssembly().Location;
            Configuration config = ConfigurationManager.OpenExeConfiguration(file);
            string connectionString = config.AppSettings.Settings[connectionName].Value;
        ...
        public static DataTable GetDataTable(string connectionString, string commandText, CommandType commandType, SqlParameter[] commandParameters)
        {
