...
namespace K3CloudCs
{
    ...
    public class ConfigHelper
    {
        ...
        public  string ReadValueByKey(ConfigurationFile configurationFile, string key)
        {
        ...
        public  string ReadConnectionStringByName(ConfigurationFile configurationFile, string name)
        {
        ...
        public  bool UpdateOrCreateAppSetting(ConfigurationFile configurationFile, string key, string value)
        {
        ...
        /// <returns>返回成功与否布尔值</returns>
        public  bool UpdateOrCreateConnectionString(ConfigurationFile configurationFile, string name, string connectionString, string providerName)
        {
            bool isSuccess = false;
            string filename = string.Empty;
            if (configurationFile.ToString() == ConfigurationFile.AppConfig.ToString())
        ...
        /// <returns>返回成功与否布尔值</returns>
        public  bool DeleteByKey(ConfigurationFile configurationFile, string key)
        {
            bool isSuccess = false;
            string filename = string.Empty;
            if (configurationFile.ToString() == ConfigurationFile.AppConfig.ToString())
        ...
        /// <returns>返回成功与否布尔值</returns>
        public  bool DeleteByName(ConfigurationFile configurationFile, string name)
        {
            bool isSuccess = false;
            string filename = string.Empty;
            if (configurationFile.ToString() == ConfigurationFile.AppConfig.ToString())
